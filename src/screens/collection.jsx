...
function ConquerBadge({ badge, conquered, accent, isMobile }) {
  return (
    <div style={{
      ...
      <div>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10.5, fontWeight: 700, letterSpacing: "0.12em", opacity: conquered ? 0.85 : 1 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.1fr 0.9fr", gap: isMobile ? 32 : 64, alignItems: "end" }}>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 12, fontWeight: 700, letterSpacing: "0.14em", color: "rgba(255,248,236,0.75)" }}>SERIES · {c.no}</span>
            ...
            <h1 style={{ fontFamily: "'Noto Serif KR', serif", fontSize: isMobile ? 44 : 84, fontWeight: 900, letterSpacing: "-0.04em", lineHeight: 0.98, margin: 0, textWrap: "balance" }}>{c.title}</h1>
          ...
          <div style={{ background: "rgba(255,248,236,0.1)", border: "1px solid rgba(255,248,236,0.25)", borderRadius: MR.cardLg, padding: isMobile ? 22 : 28 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 14 }}>
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", opacity: 0.8 }}>나의 정복 현황</span>
            ...
            return (
              <div key={cc.id} onClick={() => onNavigate("walkcourse", cc.id)} style={{
                ...
                <div style={{ position: "relative", height: isMobile ? 120 : 92, borderRadius: MR.card, background: cc.cover, display: "flex", alignItems: "flex-end", padding: 12 }}>
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, fontWeight: 800, color: "rgba(255,248,236,0.9)" }}>{cc.official ? "공식" : "유저 코스"}</span>
                  {pr.complete && (
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "4px 10px", marginTop: 8, fontFamily: "'JetBrains Mono', monospace", fontSize: 11, fontWeight: 600, color: M.muted }}>
                ...
                <div style={{ display: "flex", flexDirection: isMobile ? "row" : "column", gap: 8, alignItems: isMobile ? "center" : "stretch", justifyContent: "flex-end" }}>
                  <span style={{
                    ...
                    fontFamily: "Pretendard, sans-serif", fontSize: 13, fontWeight: 800,
          ...
          return (
            <div key={o.id} onClick={() => onNavigate("collection", o.id)} style={{ background: M.beige, borderRadius: MR.cardLg, overflow: "hidden", cursor: "pointer", boxShadow: MS.cardSm, border: `1px solid ${M.beigeAlt}` }}>
              <div style={{ height: 130, background: o.cover, padding: 18, color: M.cream, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", opacity: 0.8 }}>{o.no} · {o.kind}</span>
      ...
      <section style={{ padding: `${isMobile ? 24 : 48}px ${px}px ${isMobile ? 20 : 32}px` }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.3fr 1fr", gap: isMobile ? 16 : 56, alignItems: "end" }}>
          <div>
            ...
            <h1 style={{ fontFamily: "'Noto Serif KR', serif", fontSize: isMobile ? 36 : 80, fontWeight: 900, letterSpacing: "-0.04em", lineHeight: 1.04, margin: 0, color: M.ink, textWrap: "balance" }}>
              흩어진 코스를{isMobile ? " " : <br/>}
              ...
              <div key={s.id} onClick={() => onNavigate("collection", s.id)} style={{
                ...
                <div style={{ height: isMobile ? 200 : 240, background: s.cover, color: M.cream, padding: 22, position: "relative", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, fontWeight: 700, letterSpacing: "0.14em", opacity: 0.85, whiteSpace: "nowrap" }}>{s.no}</span>
                  ...
                  <div>
                    <div style={{ fontFamily: "'Noto Serif KR', serif", fontSize: isMobile ? 32 : 38, fontWeight: 900, letterSpacing: "-0.03em", lineHeight: 1.02 }}>{s.title}</div>
                    <div style={{ fontFamily: "'Noto Serif KR', serif", fontSize: 15, marginTop: 6, opacity: 0.85 }}>{s.subtitle}</div>
                  </div>
                </div>
                <div style={{ padding: 20, display: "flex", flexDirection: "column", flex: 1 }}>
                  ...
                  <div style={{ marginTop: "auto", paddingTop: 18 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8 }}>
                      ...
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, fontWeight: 700, color: M.muted }}>{sp.pct}%</span>
                    </div>
